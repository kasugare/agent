...
class MetastoreController:
    ...
    def set_metas_ctl(self, wf_comm_meta, wf_nodes_meta, wf_service_pool, wf_edges_meta,
        ...
        self.set_edges_grape_meta_ctl(wf_edges_grape)
        self.set_prev_edge_grape_meta_ctl(wf_prev_edge_grape)
    ...
    def set_edges_grape_meta_ctl(self, wf_edges_grape):
        self._cached_metastore_access.set_edges_grape_meta_access(wf_edges_grape)

    def set_prev_edge_grape_meta_ctl(self, wf_prev_edge_grape):
        self._cached_metastore_access.set_prev_edge_grape_meta_access(wf_prev_edge_grape)
    ...
    def get_metas_ctl(self):
        meta_pack = {
            ...
            "edges_grape": self._cached_metastore_access.get_edges_grape_meta_access(),
            "prev_edges_grape": self._cached_metastore_access.get_prev_edges_grpae_meta_access()
        }
        return meta_pack
