...
from engine.protocol.protocol_message import genJobContext, genBatchJobOrder
from engine.listener.request_handler.RequestHandler import RequestHandler


class BatchMessageHandler(RequestHandler):
    ...
    def _orderStart(self, listenerId, reqId, jobReqType, jobOrder, appCode, isReturn, params):
        ...
        jobMessage = genBatchJobOrder(jobReqType=jobReqType, jobContext=jobContext, returnPath=returnPath, isReturn=isReturn)
